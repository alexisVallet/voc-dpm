function [ds_all, bs_all, targets] = anime_bboxpred_data(model, posfolders, ...
                                                  bbfolder, negfolders)
% Collect training data for bounding box prediction for anime data.
%   [ds, bs, targets] = bboxpred_data(model, posfolders, bbfolder, negfolders)
%
% Return values
...
%
% Argument
%   model      model for bounding box prediction.
%   posfolders folders containing positive examples.
%   bbfolder   folder containing json ground truth bounding box
%              data.
%   negfolders folders containing negative examples.
...
try
  ...
  % get training data
  pos = anime_data(posfolders, bbfolder, negfolders);
