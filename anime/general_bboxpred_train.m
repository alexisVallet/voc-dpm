function model = general_bboxpred_train(model, posfolders, bbfolder, ...
                                        negfolders, method)
% Train a bounding box predictor from a previously loaded
% model. Based on bboxpred_train.
%
% Return value
...
try
  ...
  % get training data
  [ds_all, bs_all, targets] = anime_bboxpred_data(model, posfolders, ...
                                                  bbfolder, negfolders);
  name = model.class;
